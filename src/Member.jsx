    ...
    return (
        cond ?
            <div className="member rounded-4 shadow position-relative mx-auto" style={{border: '5px solid var(--secondColor)' , width: '90%' , cursor: 'pointer'}} dir={val === '1' ? 'rtl' : 'ltr'}>
                <img loading='lazy' src={img !== null && img !== undefined ? `https://cureclinckapi.amlakturks.com/storage/app/staff/${img}` : doctor1} className='rounded-4 w-100' style={{  height: '350px'}} alt="doctor" />
