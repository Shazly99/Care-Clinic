...
export default function Member({img , title , text , val , cond}) {
    ...
    return (
        cond ?
            ...
            <div className="member rounded-4 shadow position-relative mx-auto" style={{border: '5px solid var(--secondColor)' , width: '90%' , cursor: 'pointer'}} dir={val === '1' || val ===  '5' ? 'rtl' : 'ltr'}>
                <img src={img !== null && img !== undefined ? `https://cureclinckapi.amlakturks.com/storage/app/staff/${img}` : doctor1} className='rounded-4 w-100' style={{  height: '380px'}} alt="doctor" />
