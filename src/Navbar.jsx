            ...
            <div className=" container-lg container-fluid d-flex justify-content-between align-items-center">
                ...
                <div className="d-flex justify-content-between align-items-center special-div">
                  <ul className="list-unstyled d-flex justify-content-between align-items-center mb-0 px-0">
                      <li>
                        <a href="tel://+90 542 258 88 39" target='_blank' rel="noreferrer" style= {{color: '#3b5998',background:'#ecf0f8'}} >
                      ...
                      <li>
                        <a href="https://m.me/DentSpaINT" target='_blank' rel="noreferrer" style= {{color:' #0084ff',background:' #ecf5f8'}} >
                          <i className="fab fa-facebook-messenger"></i> 
                        </a>
                      </li>
                      <li>
                        <a href="mailto:info@dentspa.com.tr" target='_blank' rel="noreferrer" style={{ color:' #bc2a8d ',background:' #f8ecf4' }}>
