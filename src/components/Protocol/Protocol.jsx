      ...
      <div className="app__protocol" >
        <Container>
          <Row className='app__protocol-grid gx-lg-5 gx-0 gy-lg-0 gy-5 special-reverse'>
            <Col lg={6} className={`app__protocol-left`} dir={val === '1' ? 'rtl' : 'ltr'} >
              <h2 className='special-reverce-heading-lg mb-3'>{sec4?.Title}</h2>
              <p className={`mb-1 text-center ${val === '1' ? 'text-lg-end' : 'text-lg-start'}`} style={{ fontSize: '14px' }}>{sec4?.body}</p>
            ...
            <Col lg={6} className='app__protocol-right mx-auto'>
              <h2 className='special-reverce-heading-sm h2 mb-4 text-center' dir={val === '1' ? 'rtl' : 'ltr'}>{sec4?.Title}</h2>
